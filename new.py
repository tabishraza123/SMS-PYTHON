...
def display_menu():
    print(">>>>>>>>>>>>> MENU <<<<<<<<<<<<<")
    print(">>>> Press 1 for Register a new student")
    print(">>>> Press 2 for Display all students")
    print(">>>> Press 3 for Search students by Qualification")
    print(">>>> Press 4 for Search students by contact number")
...
path = r"C:\File handling\SMS-PYTHON\regesterstudent.json"
students_list = []
